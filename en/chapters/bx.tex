...
\todo{Maybe build a glossary in this section. See the glossary package.}
...
\missingfigure{Principles of Lenses\\ Maybe use TikZ for it.}
...
\todo{Explain Augeas' implementation of bx lenses.}

\subsection{Lenses typechecking}

\todo{Explain typechecking -- rules and errors. Put some emphasis on Augeas lenses.}


\subsection{The case of recursive lenses}

\todo{Explain recursive lenses and their typechecking specificities.}
