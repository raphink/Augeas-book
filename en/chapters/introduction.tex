...
\mint[fontsize=\footnotesize]{console}/$ sudo yum install augeas/
...
\mint[fontsize=\footnotesize]{console}/$ sudo apt-get install augeas-tool/

You might also want to install the documentation package with:

\mint[fontsize=\footnotesize]{console}/$ sudo apt-get install augeas-doc/
