...
\mint[fontsize=\scriptsize]{console}/$ sudo yum install augeas/
...
\mint[fontsize=\scriptsize]{console}/$ sudo apt-get install augeas-tool/

You might also want to install the documentation package with:

\mint[fontsize=\scriptsize]{console}/$ sudo apt-get install augeas-doc/
