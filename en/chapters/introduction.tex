...
If you wish to build the documentation for Augeas, you will to add \verb!naturaldocs! and \verb!pdflatex! to the dependencies, and add the \texttt{--with}\texttt{-naturaldocs=HTML} and \texttt{--with}\texttt{-pdfdocs} flags to the \texttt{./configure} command.
...
\mint{console}|$ sudo yum install augeas|
...
\mint{console}|$ sudo apt-get install augeas-tool|

You might also want to install the documentation package with:

\mint{console}|$ sudo apt-get install augeas-doc|
