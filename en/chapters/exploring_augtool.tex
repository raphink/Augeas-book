...
\end{itemize}
These options actually modify the value of the \verb!/augeas/save! node in the Augeas tree\footnoteref{sec:save_node}.
...
You can see if the \verb!span! functionality is activated in the current session by looking at the \verb!/augeas/span! node\footnoteref{sec:span_node}:
